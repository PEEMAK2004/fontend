          ...
          <div className="row align-items-center gx-4">
            ...
            <div className="col-md-6 offset-md-1">
              <div className="ms-md-2 ms-lg-5">
                ...
                <p className="lead">เรามีทีมงานผู้เชี่ยวชาญที่มีประสบการณ์และความรู้ด้านอนิเมะ พร้อมให้บริการลูกค้าของเราอย่างเต็มที่ เรานำเสนอโซลูชันไอทีที่หลากหลายที่ปรับแต่งให้เหมาะกับความต้องการของธุรกิจแต่ละแห่ง
